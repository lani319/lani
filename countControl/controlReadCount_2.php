...
*/
//글쓰고 하루지난거 2번 적용
$sql = "update NaraBoard_502news set hit = hit+23 WHERE TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1"; mysql_query($sql);
$sql = " update stBoard set hit = hit+7 where TO_DAYS(NOW())-TO_DAYS(LEFT(signdate,10)) =1 AND uidx IN (34904) AND bn='st'";mysql_query($sql);
$sql = " update NaraBoard_analysis set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_firstclass set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_pcolumn set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_knowhow set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_jqna set hit = hit+7 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_cosdaq_qna set hit = hit+7 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_study set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_photo set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_talkoflife set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_jtalk set hit = hit+13 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_religion set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_broadafter set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_notice set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_qna set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update NaraBoard_faq set hit = hit+23 where TO_DAYS(NOW())-TO_DAYS(LEFT(regDate,10)) =1";mysql_query($sql);
$sql = " update csBoard set hit = hit+17 where TO_DAYS(NOW())-TO_DAYS(LEFT(signdate,10)) =1";mysql_query($sql);
$sql = " update csBoard_futures set hit = hit+17 where TO_DAYS(NOW())-TO_DAYS(LEFT(regdate,10)) =1";mysql_query($sql);
