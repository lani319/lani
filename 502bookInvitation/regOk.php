...
if ($rs[cnt] >= 1)
{
	echo "<script>alert('신청이 완료되었습니다. 당첨자는 12월 7일 저녁 6시까지 개별 연락합니다.');parent.top.location.href='/index.html';this.self.close();</script>;";
}
else 
{
	echo "<script>alert('신청과정에서 오류가 발생하였습니다.다시 신청 부탁드립니다.');location.href='bookInvitation.php'</script>;";
}
