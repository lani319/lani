...
{
	echo "<script>alert('로그인 후 이용 해 주세요');parent.top.location.href='/index.html';this.self.close();</script>";
}
else 
{
...
<td height="140px" align="center">
	...
	<tr>
		...
		<tr>
		<td width="500px" align="center"><img src="/images/btnBookInvitationSubmit.gif" style="cursor:hand;" onclick="regOk();">	</td>
		<td>
			[<span style="cursor:pointer" onclick="Javascript:close_popup(1);">1일 열지않기</span>]
			<br>
			[<span style="cursor:pointer" onclick="Javascript:close_popup(3);">3일 열지않기</span>]
		</td>
		</tr>
		</table>	
