...
//var contents_price = 1004;


function pay_form_check(){
	alert('본 상품은 판매가 중단되었습니다.');
	return;
	
	var form=document.myForm;
	
	if(document.getElementById('txtMemAddr1D').value=="")
	{
	...
	if(form.pay_type[1].checked==true){ //신용카드
		if(confirm("결제금액: "+form.price.value+"원\n"+"\n결제 하시겠습니까?")){
			form.action="/include/AGS_pay_ing_InvestBook.php";
			Pay(document.myForm);
		}
	}
	else if(form.pay_type[2].checked==true){ //ARS
		if(confirm("결제금액: "+form.price.value+"원\n"+"\n결제 하시겠습니까?")){
			form.action="/include/charge_contents_process_ars_card_InvestBook.php";
			form.submit();
			return true;
		}
	}
	else{ //무통장
			form.action="/include/charge_contents_bank_result_InvestBook.html";
			form.submit();
			return true;
...
<body topmargin=0 leftmargin=0 onload="javascript:Enable_Flag(myForm);">
...
<td>
	...
	-
	<input type="text" name="txtMemPhone3" id="txtMemPhone3" style="width:40px;" maxlength="4" value="<?=$mMobile3?>">	
	</td>
	</tr>
	<tr><td colspan="2" height="5px"></td></tr>
...
<table width="700px" cellpadding="0" cellspacing="0" border="0" style="border:1px solid #6a8fb1;">
	...
	-
	<input type="text" name="txtMemPhone3D" id="txtMemPhone3D" style="width:40px;" maxlength="4" value="<?=$mMobile3?>">	
	</td>
	</tr>
	<tr><td colspan="2" height="5px"></td></tr>
	<tr>
...
<td>
	...
	<tr><td colspan="2" height="5px"></td></tr>
	<tr align="center">
	<td  valign="top"><input type="radio" name="pay_type" value="bank" checked >무통장 입금</td>
	<td  valign="top"><input type="radio" name="pay_type" value="card" >신용카드</td>
	<!--
	...
	-->
	<td  valign="top"><input type="radio" name="pay_type" value="ARS" >ARS카드결제</td>	
	</tr>
	<tr><td colspan="2" height="5px"></td></tr>
	</tr>
	</table>
...
<tr><td colspan="5" height="10px"></td></tr>
<tr>
<td colspan="5" align="center"><img src="img/order/btnPaySubmit.gif" style="cursor:hand;" onclick="pay_form_check();"></td>
</tr>
</table>
</body>
</html>