...
<?php
$query = "select A.userName,A.userNickname,A.mobile,A.userId,B.regDate,B.idx from Member A inner join 2011dongbuLecture B on A.userId = B.memID where B.regDate > '2011-06-01 00:00:00' order by B.regDate ASC";
